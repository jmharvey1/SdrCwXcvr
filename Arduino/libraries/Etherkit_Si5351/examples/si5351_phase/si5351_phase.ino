...
//  unsigned long long pll_freq = 70500000000ULL;
  float MFreq = 3500.005; //Desired Frequency in Khz
  unsigned long long freq = (3500.005*1000)ULL   ;//1410000000ULL;
  unsigned long long pll_freq = freq*50;//70500000000ULL;
